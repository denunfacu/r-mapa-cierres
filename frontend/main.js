...
const iconCasa = L.icon({ iconUrl: 'icons/casa.png', iconSize: [25, 25], iconAnchor: [16, 32] });
const iconEdificio = L.icon({ iconUrl: 'icons/edificio.png', iconSize: [25, 25], iconAnchor: [16, 32] });
const iconCochera = L.icon({ iconUrl: 'icons/cochera.png', iconSize: [25, 25], iconAnchor: [16, 32] });
const iconHotel = L.icon({ iconUrl: 'icons/hotel.png', iconSize: [25, 25], iconAnchor: [16, 32] });
const iconTerreno = L.icon({ iconUrl: 'icons/terreno.png', iconSize: [25, 25], iconAnchor: [16, 32] });
const iconAgrupado = L.icon({ iconUrl: 'icons/varios.png', iconSize: [32, 32], iconAnchor: [16, 32] });
const iconOtro = L.icon({ iconUrl: 'icons/otro.png', iconSize: [25, 25], iconAnchor: [16, 32] });
